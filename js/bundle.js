...
function calc() {
  ...
  var choose = document.querySelector(".calculating__result span");
  var sex, weight, height, age, ratio;
  ...
  function changeSelect(selector, active) {
    var elements = document.querySelectorAll("".concat(selector, " .calculating__choose-item"));
  ...
  function getStaticInfo(parent, acivSelector) {
    var elements = document.querySelectorAll("".concat(parent, " .calculating__choose-item"));
    elements.forEach(function (el) {
      el.addEventListener('click', function (e) {
        ...
        elements.forEach(function (el) {
          return el.classList.remove(acivSelector);
        });
  ...
  function getDinamicInfo() {
    var dinamic = document.querySelectorAll(".calculating__choose_medium .calculating__choose-item");
    dinamic.forEach(function (i) {
...
function cards() {
  var NewSubject = /*#__PURE__*/function () {
    function NewSubject(src, alt, title, descr, price, parent) {
      _classCallCheck(this, NewSubject);
    ...
    _createClass(NewSubject, [{
      key: "transferUHA",
      value: function transferUHA() {
      ...
      value: function include() {
        ...
        var myParent = document.querySelector(this.parent);
        ...
        if (this.clasess.length > 0) {
          ...
          this.clasess.forEach(function (item) {
  ...
  fetch("http://localhost:3000/menu").then(function (data) {
    ...
    arr.forEach(function (_ref) {
      var img = _ref.img,
          ...
          descr = _ref.descr,
          price = _ref.price;
      var obj = new NewSubject(img, alt, title, descr, price, ".menu__field .container");
      obj.include();
    });
  });
}
...
function closeModal() {
  var modal = document.querySelector("[data-modal-open]");
  var loadingEl = document.querySelector("form").querySelector("[data-loading]");
...
function modalWindow(openDModal, closeModal, timer) {
  var btn = document.querySelectorAll("[data-modal]"),
      modal = document.querySelector("[data-modal-open]");
  btn.forEach(function (item) {
    item.addEventListener("click", function () {
      return openDModal(timer);
    });
  });
  var scroleOpen = 1;
...
function slider(_ref) {
  var sledeS = _ref.sledeS,
      prev = _ref.prev,
      offerSled = _ref.offerSled,
      next = _ref.next,
      offerSliderIn = _ref.offerSliderIn,
      wrapp = _ref.wrapp;
  ...
  var nowSlide = document.querySelector("#current");
  var lengthSlider = document.querySelector("#total"); // create indicator
  ...
  for (var i = 0; i < slids.length; i++) {
    ...
    dot.setAttribute("data-indicator", "".concat(i + 1));
  ...
  if (slids.length < 10) {
    ...
    lengthSlider.innerHTML = slids.length;
  }

  var indexSlider = 1;
  var offsetSlider = 0; // indecator function
  ...
  var fulDots = dots.querySelectorAll('li');
  indicatorSet();
  currentSlider(indexSlider);

  function indicatorSet() {
    fulDots.forEach(function (e) {
      e.style.opacity = '.5';
  ...
  ;
  previosSlid.addEventListener("click", function () {
    if (offsetSlider == 0) {
    ...
    currentSlider(indexSlider);
    sliderFullWidth.style.transform = "translateX(".concat(-offsetSlider, "px)");
    indicatorSet();
  });
  nextSlid.addEventListener("click", function () {
...
function tabs(parentsSelector, selector, tab, activeClass) {
  var tHeader = document.querySelector(parentsSelector),
  ...
  function showTabContant() {
    var element = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
  ...
  tHeader.addEventListener("click", function (event) {
    ...
    if (target && target.classList.contains(selector.slice(1))) {
      tItem.forEach(function (item, index) {
        if (item === target) {
          clearTabContant();
...
function serverPost(openModal, closeModal, timer) {
  ...
  var createPost = /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(src, data) {
      var res;
  ...
  function postForm(form) {
    form.addEventListener("submit", function (e) {
      e.preventDefault();
      var requestStatus = document.createElement('img');
      ...
      createPost("http://localhost:3000/requests", JSON.stringify(objectForJson)).then(function (data) {
        return data.json();
      }).then(function (data) {
  ...
  function showModalThanks(massege) {
    ...
    modal.classList.add("hire");
    newModal.innerHTML = "\n      <div class=\"modal__dialog\" data-messeage-dialog>\n      <div class=\"modal__content\">\n      <div date-close class=\"modal__close\">\xD7</div>\n      <div>".concat(massege, "</div>\n      <div>\n      ");
...
/* harmony default export */ __webpack_exports__["default"] = (serverPost);
...
function timer(selector, endTime) {
  function ourTime(time) {
    var getTime = Date.parse(time) - Date.parse(new Date()),
  ...
  function returnTimer(setTime, puth) {
    var time = ourTime(setTime);

    function setTimer(puth) {
      var ourTimer = document.querySelector(puth),
  ...
  var startTimer = setInterval(onTimer, 1000);
}
...
/* harmony import */ var _modules_thanksModal__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/thanksModal */ "./js/modules/thanksModal.js");
...
document.addEventListener("DOMContentLoaded", function () {
  var time = setTimeout(function () {
    (0,_modules_modal__WEBPACK_IMPORTED_MODULE_3__.openModal)(time);
  }, 5000);
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_1__["default"])(".tabheader__items", ".tabheader__item", ".tabcontent", "tabheader__item_active");
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])(".promotion__timer", "2023-04-01");
  (0,_modules_cards__WEBPACK_IMPORTED_MODULE_4__["default"])();
  (0,_modules_modal__WEBPACK_IMPORTED_MODULE_3__["default"])(_modules_modal__WEBPACK_IMPORTED_MODULE_3__.openModal, _modules_modal__WEBPACK_IMPORTED_MODULE_3__.closeModal, time);
  (0,_modules_thanksModal__WEBPACK_IMPORTED_MODULE_5__["default"])(_modules_modal__WEBPACK_IMPORTED_MODULE_3__.openModal, _modules_modal__WEBPACK_IMPORTED_MODULE_3__.closeModal, time);
